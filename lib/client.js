...
function Client(conf) {
    ...
    function request(method, url, data, cb) {
        // console.log('method: '+method, 'url: '+ decodeURIComponent(url), 'data:',data[0] || {});
        if (DEBUG == true) console.log('SOLR-HYPERQUEST-CLIENT'.red.inverse, decodeURIComponent(url).white.inverse);
        // console.log('method: ' + method, 'url: ' + url, 'data:' + (!_.isEmpty(data)));
        if (DEBUG == true) console.log('method: ' + method, 'url: ' + url, 'data:', data);
